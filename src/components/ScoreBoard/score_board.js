...
const ScoreBoard = ({ score, highscore, toggleHandler, state }) => {
  return (
    <div className="flex sm:flex-col flex-row mt-10 sm:my-auto">
      ...
      <div className="flex-1 text-base text-center text-green font-bold">
        {score}
      </div>
      ...
      <div className="flex flex-1">
        <button
          className="text-base text-white shadow rounded border border-opacity-25 bg-green mx-auto p-1 sm:mt-6 w-16"
